...
const DashboardLight = () => {
  ...
  const [model, setModel] = useState('Alphacoin');
  const [strategy] = useState('Breakout Strategy');
  const [confidenceThreshold, setConfidenceThreshold] = useState(0.955);
  const [tpForecast] = useState(12.3);
  const [slForecast] = useState(4.8);
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <select
                ...
                className="px-2 py-1 text-gray-900 bg-white border border-gray-400 rounded"
              >
