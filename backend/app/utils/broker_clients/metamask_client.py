# backend/utils/broker_clients/metamask_client.py
...
class MetaMaskClient:
    ...
    async def login(self, wallet_address=None, rpc_url=None):
        ...
        if not self.web3.isConnected():
            raise ConnectionError("MetaMask RPC connection failed")
    ...
    async def get_account_info(self):
        ...
        return {
            ...
            "margin_percent": 0.0,
            "native_currency": "ETH",
            "layer2": "polygon" in self.rpc_url.lower() or "arbitrum" in self.rpc_url.lower()
        }
